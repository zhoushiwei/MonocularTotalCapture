...
cpt = '/Users/zhoushiwei/Desktop/MonocularTotalCapture/POF/snapshots/Final_qual_domeCOCO_chest_noPAF2D/model-390000'
load_weights_from_snapshot(sess, cpt, discard_list=['Adam', 'global_step', 'beta'], rename_dict={'CPM': 'body/CPM'})
cpt = '/Users/zhoushiwei/Desktop/MonocularTotalCapture/POF/snapshots/Final_qual_hand_clear_zoom/model-160000'
...
for i, frame_index in enumerate(frame_indices):
    ...
    """
    print(bcrop_center2d_smooth.size)
