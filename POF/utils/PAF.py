...
dist_thresh = 8
if os.path.exists('/Users/zhoushiwei/Desktop/MonocularTotalCapture/POF/utils/default_PAF_lengths.json'):
    with open('/Users/zhoushiwei/Desktop/MonocularTotalCapture/POF/utils/default_PAF_lengths.json', 'r') as f:
